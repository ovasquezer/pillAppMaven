 ...
 * @author jvasquez
 */
@WebServlet(name = "RemoveProjectServlet", urlPatterns = {"/RemoveProjectServlet"})
public class RemoveProjectServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet RemoveProjectServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet RemoveProjectServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {
            out.close();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(RemoveProjectServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
